...
const Footer = () => {
  ...
  return (
    <div className="app flex items-end justify-center font-poppins">
      <div className="py-16 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 bg-orange-800 text-white w-full p-4 relative">
        <div className="  ">
          ...
          <div className="infos text-white-400 pt-4 pb-4">
            <a href='https://bakhtawr.github.io/3dfolio/' target='_blank'><span>Copyright © 2023 3DFolio</span></a>
          ...
          <div className="footer-icons flex items-center space-x-3">
            {socialLinks.map((socialLink, index) => {
              ...
              return (
                <Icon
                  key={`social-${index}`}
                  className="w-14 h-14 p-2 rounded-full bg-orange-700 hover:bg-white hover:text-orange-700 cursor-pointer"
                />
              );
            })}
          </div>
